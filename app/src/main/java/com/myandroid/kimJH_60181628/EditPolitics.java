...
public class EditPolitics extends AppCompatActivity {
    SQLiteDatabase db;
    DbHelperPolitics DbHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_politics);

        DbHelper = new DbHelperPolitics(this);
        ...
        if (cursor != null) {
            if (cursor.moveToFirst()) {
                ...
                mDateText.setText(cursor.getString(cursor.getColumnIndex(DbHelper.DATE)));
                mSummaryText.setText(cursor.getString(cursor.getColumnIndex(DbHelper.SUMMARY)));
                mSourceText.setText(cursor.getString(cursor.getColumnIndex(DbHelper.SOURCE)));
    ...
    public void onBackPressed() {
        Intent setIntent = new Intent(this, ListPolitics.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.action_save:
                ...
                Intent openMainScreen = new Intent(EditPolitics.this, ListPolitics.class);
