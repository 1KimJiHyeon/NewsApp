...
public class EditIT extends AppCompatActivity {
    SQLiteDatabase db;
    DbHelperIT DbHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_it);
    ...
    public void onBackPressed() {
        Intent setIntent = new Intent(this, ListIT.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.action_save:
                ...
                Intent openMainScreen = new Intent(EditIT.this, ListIT.class);
