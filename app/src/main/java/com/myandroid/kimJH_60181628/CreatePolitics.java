...
public class CreatePolitics extends AppCompatActivity {
    SQLiteDatabase db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_politics);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.action_save:
                ...
                Intent openMainScreen = new Intent(this, ListPolitics.class);
